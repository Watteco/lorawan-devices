      ...
      if (decodedBatch === false){
        ...
        if((cmdID === 0x0a)|(cmdID === 0x8a)|(cmdID === 0x01)){
          ...
          //voltage current multi metering
            ...
            tab.push({label: "PhaseA", value: UintToInt(bytes[index+5]*256+bytes[index+6],2)/10, date: lDate});
            ...
            tab.push({label: "PhaseB", value: UintToInt(bytes[index+11]*256+bytes[index+12],2)/10, date: lDate});
            ...
            tab.push({label: "PhaseC", value: UintToInt(bytes[index+17]*256+bytes[index+18],2)/10, date: lDate});
			  	}
